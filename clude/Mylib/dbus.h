...
#define KEY_W         ((rc_ctrl.key.v & ((uint16_t)0x01<<0)) >> 0) 
#define KEY_S         ((rc_ctrl.key.v & ((uint16_t)0x01<<1)) >> 1) 
#define KEY_A         ((rc_ctrl.key.v & ((uint16_t)0x01<<2)) >> 2) 
#define KEY_D         ((rc_ctrl.key.v & ((uint16_t)0x01<<3)) >> 3) 
#define KEY_SHIFT     ((rc_ctrl.key.v & ((uint16_t)0x01<<4)) >> 4) 
#define KEY_CTRL      ((rc_ctrl.key.v & ((uint16_t)0x01<<5)) >> 5) 
#define KEY_Q     	  ((rc_ctrl.key.v & ((uint16_t)0x01<<6)) >> 6) 
#define KEY_E         ((rc_ctrl.key.v & ((uint16_t)0x01<<7)) >> 7) 
#define KEY_R         ((rc_ctrl.key.v & ((uint16_t)0x01<<8)) >> 8) 
#define KEY_F         ((rc_ctrl.key.v & ((uint16_t)0x01<<9)) >> 9) 
#define KEY_G         ((rc_ctrl.key.v & ((uint16_t)0x01<<10)) >> 10) 
#define KEY_Z         ((rc_ctrl.key.v & ((uint16_t)0x01<<11)) >> 11) 
#define KEY_X         ((rc_ctrl.key.v & ((uint16_t)0x01<<12)) >> 12) 
#define KEY_C         ((rc_ctrl.key.v & ((uint16_t)0x01<<13)) >> 13) 
#define KEY_V         ((rc_ctrl.key.v & ((uint16_t)0x01<<14)) >> 14) 
#define KEY_B         ((rc_ctrl.key.v & ((uint16_t)0x01<<15)) >> 15)
