...
#define IIC_SCL_H()      GPIO_SetBits(GPIOC,GPIO_Pin_7)
#define IIC_SCL_L()      GPIO_ResetBits(GPIOC,GPIO_Pin_7)
#define IIC_SDA_H()      GPIO_SetBits(GPIOC,GPIO_Pin_6)
#define IIC_SDA_L()      GPIO_ResetBits(GPIOC,GPIO_Pin_6)
#define IIC_SDA_Read()   GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_6)
